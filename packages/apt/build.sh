...
TERMUX_PKG_DEPENDS="coreutils, dpkg, findutils, gpgv, grep, io-vaj-keyring, libandroid-glob, libbz2, libc++, libiconv, libgcrypt, libgnutls, liblz4, liblzma, sed, termux-keyring, termux-licenses, xxhash, zlib, zstd"
...
termux_step_post_make_install() {
	...
	cat > $TERMUX_PREFIX/etc/apt/sources.list << VAJEOF
deb [signed-by=/data/data/io.vaj.tl/files/usr/etc/apt/keyrings/io-vaj-archive.gpg] https://repo.pathayam.xyz stable main
VAJEOF
