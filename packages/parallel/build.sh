...
# VAJ: the 20260622 tarball is zero bytes on ftp.gnu.org and every mirror tried
# (HTTP 200, empty body), so the pinned release is unusable upstream. 20260722 is
# intact; version and checksum move together.
TERMUX_PKG_VERSION="20260722"
TERMUX_PKG_SRCURL=https://mirrors.kernel.org/gnu/parallel/parallel-${TERMUX_PKG_VERSION}.tar.bz2
TERMUX_PKG_SHA256=afe4b572a4334aac3a002a080ad618249f00b84d7659d03e77412727d18f1ad6
