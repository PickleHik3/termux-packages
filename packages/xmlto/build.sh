...
# VAJ: www.pagure.io/xmlto/archive/... now 404s. releases.pagure.org serves the
# same tarball -- verified byte-identical, TERMUX_PKG_SHA256 below is unchanged.
TERMUX_PKG_SRCURL=https://releases.pagure.org/xmlto/xmlto-${TERMUX_PKG_VERSION}.tar.gz
